...
// Per-scanline scroll/window capture (144 scanlines * 4 bytes: scx, scy, wx, wy)
export const SCANLINE_DEBUG_BUFFER_LOCATION: i32 = DEBUG_GAMEBOY_MEMORY_LOCATION + DEBUG_GAMEBOY_MEMORY_SIZE + 1;
export const SCANLINE_DEBUG_BUFFER_SIZE: i32 = 144 * 4;

// Final General Size
export const WASMBOY_MEMORY_LOCATION: i32 = 0x000000;
export const WASMBOY_MEMORY_SIZE: i32 = SCANLINE_DEBUG_BUFFER_LOCATION + SCANLINE_DEBUG_BUFFER_SIZE;
